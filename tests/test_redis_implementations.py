...
class TestRedisMethods(unittest.TestCase):
    ...
    def test_set_hash_successful(self, mock_set_hash):
    ...
    @patch('containers.Readers')
    def test_set_hash_failure_non_existing_hash(self, mock_set_hash):
        mock_set_hash.return_value = "{}".format(self.test_redis_methods.set_hash(self.hash_name, self.key, self.value))
        self.assertEqual(mock_set_hash.return_value, '0')

    @patch('containers.Readers')    
    def test_get_hash_successful(self, mock_get_hash):
    ...
    @patch('containers.Readers')    
    def test_get_hash_failure_non_existing_hash(self, mock_get_hash):
        self.hash_name = 'test_key'
    ...
    @patch('containers.Readers')    
    def test_get_dict_hash_successful(self, mock_get_dict_hash):
    ...
    @patch('containers.Readers')    
    def test_get_dict_hash_failure_non_existing_hash(self, mock_get_dict_hash):
        self.hash_name = 'test_key'
    ...
    @patch('containers.Readers')    
    def test_hash_check_successful(self, mock_hash_check):
    ...
    @patch('containers.Readers')    
    def test_hash_check_failure_non_existing_hash(self, mock_hash_check):
        self.hash_name = 'test_key'
    ...
    @patch('containers.Readers')
    def test_delete_hash_successful(self, mock_detele_hash):
    ...
    @patch('containers.Readers')
    def test_delete_hash_failure_non_existing_hash(self, mock_detele_hash):
        self.hash_name = 'test_key'

        mock_detele_hash.return_value = self.test_redis_methods.delete_hash(self.hash_name, self.key)
        self.assertEqual(mock_detele_hash.return_value, 0)
